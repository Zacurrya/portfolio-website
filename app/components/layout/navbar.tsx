...
function Navbar() {
    ...
    return (
        <nav
            className="fixed top-0 left-0 right-0 z-40 w-full bg-[#004C9C] backdrop-blur-sm overflow-hidden transition-transform duration-300 ease-in-out"
            style={{ transform: isVisible ? 'translateY(0)' : 'translateY(-200px)' }}
        >
            <div className="mx-auto h-10 md:h-16 px-4 md:px-6 py-3 relative overflow-hidden max-w-[1280px]">
                {/* Logo */}
                <a href="#home">
                    <img
                        src="/logo.svg"
